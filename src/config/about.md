<!--
  👋  This file is the About section of your homepage, written in Markdown.
  Everything here is rendered with the site's own look:
    • **bold** text gets the soft coral highlighter effect
    • > quotes render as an accent-barred blockquote
    • [links](https://example.com) open in a new tab with a small ↗ icon
    • - lists render as tidy bullet / numbered lists
-->
